...
pagina = st.sidebar.radio(
    'Menù', ['HOME', 'RANDOM GENERATOR', 'CODICE SORGENTE', 'IMPOSTAZIONI'], index=3)
...
if pagina == 'HOME':
    ...
    st.write(''' **Per proseguire clicca sul tasto start:**\n
    N.B. :\n
    ...
    if start:
        ...
        time.sleep(10)  # do il tempo di cliccare continua
    ...
    \n ### Seleziona il tipo di dispositivo che stai utilizzando: \n

    N.B.: alcune funzionalità sono disponibili solo utilizzando un coputer\n
    ''')

    conferma = False
    dispositivo = st.radio('Menù', ['MOBILE', 'PC-LAPTOP'], index=1)
    if dispositivo == 'PC-LAPTOP':
        st.write('\n ### Seleziona il Browser che vuoi utilizzare:\n')
        browser_type = st.radio('Browser', ['CHROME', 'FIREFOX'], index=0)
