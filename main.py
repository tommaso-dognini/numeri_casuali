...
st.write('''
    ...
    N.B.: alcune funzionalità sono disponibili sono utilizzando un coputer\n
''')
conferma = False
dispositivo = st.radio('Menù', ['MOBILE', 'PC-LAPTOP'])
if dispositivo == 'PC-LAPTOP':
    st.write('\n ### Seleziona il Browser che vuoi utilizzare:\n')
    browser_type = st.radio('Browser', ['CHROME', 'FIREFOX'])

conferma = st.button('CONFERMA')
        ...
        if pagina == 'HOME':
            ...
            if start:
                ...
                if frequenze_assolute:
                    ...
                    st.write(
                        '''### Risultati dell'estrazione:FREQUENZE ASSOLUTE\n''')
